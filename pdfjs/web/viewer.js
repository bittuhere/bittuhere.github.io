...
function beforeUnload(evt) {
  // Arcade Hub patch: disabled. This handler fired "Leave site?" dialogs even
  // for read-only PDFs (any touched annotation state registers it), and from
  // inside the viewer iframe it can block navigation of the whole page.
}
