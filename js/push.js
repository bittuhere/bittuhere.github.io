...
(function (global) {
    ...
    function initMessaging() {
        ...
        try {
            ...
            // Foreground: site is open — show an in-app toast instead of a system popup.
            messaging.onMessage(function (payload) {
                ...
                try {
                    if (typeof global.showNotify === 'function') {
                        global.showNotify(title + (body ? ': ' + body : ''), data.nt || 'info');
                    }
                } catch (e) {}
                // Also nudge the notification bell dot.
